...
<div id="addsubject">
 		<form action="addsubject" method="post">
 			<table align="center" ">
 			<tr>
 			<th colspan="2" style="text-align: center">Add Subject</th>
 		</tr>
 				...
 				<tr>
 					<td>Enter Subject:</td>
 					<td>
 						<input type="text"  id="newsub" name="newsub">
 					</td>
 				</tr>
 				...
 				<tr>
 					...
 					<td colspan="2" style="text-align: center"><center><input type="submit" value="Add Subject" ></center></td>
 				</tr>
